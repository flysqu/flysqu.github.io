...
- make gifs randomly place themselves on the right and left side next to page content
- refactor script.js and tech-js to be the same files as the code is 99% the same
